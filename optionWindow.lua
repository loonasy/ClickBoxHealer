...
function cbh.FrameOptions()
	...
	cbhcallinglist = {"Warrior", "Cleric", "Mage", "Rogue", "Primalist", "Percentage", "BackColor", "HealthColor", "Absorb Shield"}
	cbhclindex = 1
	...
	cbh.OptionsCallingSelector.Event.ItemSelect = function(view, item, value, index)
		...
		if cbhclindex == 7 or cbhclindex == 8 then
	...
	function cbh.UpdateCallingColorChanges()
		...
		elseif sel == 8 then	--health color
		...
		elseif sel == 9 then	--absorb color
